"""
Django settings for tron_chain_scanner project.
...
ALLOWED_HOSTS = ['tron-chain-scanner.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'tron_chain_scanner.urls'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'tron-chain-scanner-milestone4'
...
DEFAULT_FROM_EMAIL = 'tronchainscanner@example.com'

# EMAIL SETTINGS
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'chibitalesorg@gmail.com'
else:
